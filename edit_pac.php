					...
					<div class="card-body">
						<form action="edit_pac.php?paciente_id= <?php echo $_GET['paciente_id']; ?>" method="POST">
							...
							<div class="form-group">
								...
								<input type="text" name="eps" value="<?php echo $eps?>" class="form-control" placeholder="EPS">
							</div>
							<div class="form-group">
								<label for="rem-entity">Entidad Remitente</label>
								<input type="text" name="entity" value="<?php echo $entidad?>" class="form-control" placeholder="Entidad">
							</div>
							<div class="form-group">
