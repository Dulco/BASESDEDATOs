					...
					<div class="card card-body">
                		<form action="" method="POST">
                   			<div class="row">
								...
								<div class="col">
								<input type="int" name="identificacion" class="form-control"
                        			placeholder="Buscar documento" autofocus>
                    			</div>
                    			<div class="col">
                        			<input type="int" name="eps" class="form-control"
                        			placeholder="Buscar EPS" autofocus>
                    			</div>
								<div class="col">
                        			<input type="int" name="entidad" class="form-control"
                        			placeholder="Buscar entidad" autofocus>
                    			</div>
                    			<div class="col">
                    				<input type="date" name="inicio" value="1999-01-01" min="1999-01-01"
                                  	max="2050-01-01" step="1">
                    			</div>
								<div class="col">
                    			<input type="date" name="fin" value="2050-01-01" min="1999-01-01"
                                max="2050-01-01" step="1">
                    			</div>
								<div class="col">
